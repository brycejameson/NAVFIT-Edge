...
### Latest Release (Beta): [v0.6.2](https://github.com/brycejameson/NAVFIT-Edge/archive/refs/tags/v0.6.2.zip)
...
[View a live demo.](https://navfitedge.infinityfree.io/)
...
_Copies of the .html file and anything they create can be saved virtually anywhere.  It can be opened from a command's shared drive, a CD, from OneDrive, or from a command's website.  It requires ZERO installation, ZERO internet connectivity and ZERO dependencies to run._
...
### NAVFIT98A forms don't use all the available space in the NAVPERS form!  Why doesn't NAVFIT-Edge make it better?
_It certainly can.  NAVFIT-Edge can be easily be adjusted to make more efficient use of the space provided. We'll cross that bridge when PERS32 is ready to do so._
...
_Yes.  NAVFIT-Edge opens and runs in your browser and saves summary groups wherever you tell Windows to save them, such as My Documents, your OneDrive, your shared drive, or whatever you want.  The saved files (not the PDFs) are SHA-256 encrypted and only readable using NAVFIT-Edge.  You can also add protection using an optional encrypted passphrase, similar to the way SAFE works for file dropoffs._
