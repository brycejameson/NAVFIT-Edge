...
### Latest Release (Alpha): [v0.6.1](https://github.com/brycejameson/NAVFIT-Edge/archive/refs/tags/v0.6.1.zip)
...
* _Cost_
* _Navy IA vetting/Network Security_
...
_The reports are designed to be indistinguishable from those generated by NAVFIT98A.  Paper reports are still manually examined and scanned until decision-makers prioritize spending the money to design and implement a more sustainable and reliable system._

### Will it work on Flankspeed?
_Yep._

### Will it work on classified systems?
_If they run Windows with Microsoft Edge or a Chrome-based browser, then yes._
